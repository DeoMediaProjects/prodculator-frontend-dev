...
export const TOOLTIP_TEXTS = {
  ...
  costEfficiency: "Measures how far your budget stretches in this territory — primarily through crew day rates, but also reflecting equipment and production costs. Computed from published union and guild rate scales in our database, benchmarked against the UK market and converted at live exchange rates. A hard data calculation — not an estimate.",
