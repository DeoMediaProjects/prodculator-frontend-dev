...
export function normaliseAnalysisData(
  ...
  return {
    ...
    scoringMethodology: analysisData.scoringMethodology ?? null,
    scriptOriginCallout: analysisData.scriptOriginCallout ?? null,
    territoryDeepDives: analysisData.territoryDeepDives ?? null,
    financialReadiness: analysisData.financialReadiness ?? null,
...
export function mapReportToAnalysis(report: any, metadata: ScriptMetadata, isPreview = false): ScriptAnalysis {
  ...
  return {
    ...
    scoringMethodology: reportData.scoringMethodology ?? null,
    scriptOriginCallout: reportData.scriptOriginCallout ?? null,
    territoryDeepDives: reportData.territoryDeepDives ?? null,
    financialReadiness: reportData.financialReadiness ?? null,
